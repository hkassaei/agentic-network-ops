...
def lint_synthesis_pool_membership(
    ...
    return GuardrailResult(
        ...
        reason=(
            ...
            "is NOT in the candidate pool. The pool is the verified set "
            "of NFs you are allowed to diagnose:\n\n"
            ...
            "rather than naming an NF outside the pool — a bounded "
            "re-investigation was already run if this was an "
