...
#
# Usage: ./scripts/e2e-vonr-test.sh
#
# To clean up afterward: ./scripts/teardown.sh
# =============================================================================
...
build_if_missing "docker_open5gs"  "./network/base"
build_if_missing "docker_kamailio" "./network/ims_base"
build_if_missing "docker_ueransim" "./network/ueransim"
...
build_if_missing "docker_ueransim_pjsua" -f "ueransim/Dockerfile" "ueransim/"
...
docker cp "$REPO_ROOT/kamailio/pcscf/kamailio_pcscf.cfg" pcscf:/etc/kamailio_pcscf/kamailio_pcscf.cfg
log_ok "P-CSCF kamailio config updated (UDP for oversized SIP messages)"

docker cp "$REPO_ROOT/kamailio/pcscf/pcscf.cfg" pcscf:/mnt/pcscf/pcscf.cfg
log_ok "P-CSCF config updated (IPsec disabled)"

docker cp "$REPO_ROOT/kamailio/scscf/scscf.cfg" scscf:/mnt/scscf/scscf.cfg
